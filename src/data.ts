...
export const PROCESS_STEPS: ProcessStep[] = [
  {
    ...
    description: 'We initiate the cycle with an in-depth conversation. We dissect your target audience, identify the emotional core of your story, and align on visual and tonal reference frameworks.',
    details: [
      'Visual references & mood-board definition',
      'Narrative structure & script analysis',
      'Audio environment & soundtrack direction'
    ]
  },
  {
    step: '02',
    title: 'The Edit & Pacing',
    description: 'The physical assembly. We sculpt your raw footage into an intentional sequence, focusing on narrative rhythm, eye tracking, and precise temporal alignment that holds visual interest.',
    details: [
      'First-pass rough cut assembly',
      'Dynamic pacing & narrative curve sculpting',
      'Vocal pacing cleanup & conversational rhythm matching'
    ]
  },
  {
    step: '03',
    title: 'Refinement & Mastery',
    description: 'Elevating the piece through high-fidelity visual and audio treatment. We apply custom color grading, sound design layers, kinetic overlays, and text reveals to establish a premium feel.',
    details: [
      'High-contrast professional color grading',
      'Multi-track audio mastering & foley integration',
      'Kinetic typography & minimal motion graphic overlays'
    ]
  },
  {
    step: '04',
    title: 'Delivery & Precision',
    description: 'Polishing and preparing the files for optimal presentation across theater screens, social channels, or direct high-bandwidth web pages in various dynamic ratios.',
    details: [
      'Multi-aspect rendering (16:9, 9:16)',
      'High-bitrate master file rendering',
